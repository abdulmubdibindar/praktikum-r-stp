...
Mengapa mahasiswa yang tinggal lebih jauh dari kampus biaya perjalanan sepekannya lebih kecil? Bukankah biaya transportasi makin jauh malah makin mahal? Apa kira-kira penyebab kecilnya biaya perjalanan tersebut?
...
```{r mod08-model-summary-2, echo=TRUE, results='hide'}
...
1. Nilai `Residual standard error` harus dikalikan dengan 1000 terlebih dahulu untuk mengetahui rata-rata galat antara biaya perjalanan dari data yang sebenarnya dengan hasil perhitungan model. Berapakah besar galat biaya perjalanan sepekan antara data dengan hasi perhitungan?
2. Berapa persen variansi biaya perjalanan sepekan yang dijelaskan oleh variansi jarak perjalanan ke kampus?
3. Apakah penjelasan variabel jarak perjalanan ke kampus terhadap biaya perjalanan sepekan hanya terjadi secara kebetulan di sampel kita?
