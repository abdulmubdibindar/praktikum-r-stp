...
Kita juga dapat menggunakan penamaan variabel lain selain `x` dan `y` untuk memudahkan interpretasi. Untuk kasus ini, kita bisa menggunakan kata $biaya$ untuk menggantikan $y$, $jarak$ untuk menggantikan $x_1$, $lingKos_sendiri$ untuk menggantikan $x_2$, dan seterusnya.
