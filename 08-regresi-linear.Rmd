...
```{r mod08-create-initial-scatterplot}
...
```{r mod08-recalculate-correlation}
...
```{r mod08-create-clean-scatterplot}
# Membuat diagram pencar antara variabel jarak dan biaya transportasi sepekan
...
```{r mod08-display-model-table-basic}
...
```{r mod08-display-model-table-custom}
tbl_regression(
  model,
...
```{r mod08-visualize-regression-line-1}
# Membuat diagram pencar antara variabel jarak dan biaya transportasi sepekan
# untuk mahasiswa yang pakai layanan online, setelah pencilan dihilangkan,
...
```{r mod08-visualize-regression-line-2}
# Membuat diagram pencar antara variabel jarak dan biaya transportasi sepekan
# untuk mahasiswa yang pakai layanan online, setelah pencilan dihilangkan,
# ditambah garis dari persamaan regresi
scp <- ggplot(data = data_mahasiswa_online,
...
```{r mod08-predict-multiple-model}
