...
Untuk menjalankan kode dari file `.R` ke Console tanpa mengetik ulang: 1. Sorot (blok) baris kode yang ingin dijalankan di panel *Script* (jendela kiri atas). 2. Tekan kombinasi tombol **Ctrl + Enter** (Windows/Linux) atau **Cmd + Enter** (Mac).
...
├── datasets/
│   ├── data_penduduk.xlsx
│   ├── data_transportasi.csv
│   └── survei_persepsi.xlsx
├── output/
│   └── hasil_analisis.xlsx
├── modul_1.R
└── modul_2.R
