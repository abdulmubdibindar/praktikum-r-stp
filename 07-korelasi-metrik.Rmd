...
Buat dataset baru dari `data_mahasiswa` yang tadi dimuat sehingga berisi hanya mahasiswa UBL (`` filter(Kampus_PT == 'UBL') ``).
...
```{r mod07-create-scatterplot, include=FALSE}
...
```{r mod07-correlation-spearman, include=FALSE}
# Mengatur variabel x dan y
x <- data_ubl$jarak
...
# Membuat diagram pencar antara variabel jumlah perjalanan weekdays dan
# jarak tempat tinggal pengguna online
scatter_plot <- ggplot(
