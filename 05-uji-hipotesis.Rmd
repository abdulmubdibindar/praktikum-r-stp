...
if (jenis_uji == "dua ekor") {
  if (abs(z_mean_jarak) < abs(qnorm(alpha / 2))) {
    tolak_h0 <- FALSE
    cat("gagal menolak hipotesis kosong. Perbedaan rata-rata sampel", round(sample_mean, 2), "dengan", pop_mean, "hanyalah kebetulan")
  } else {
    tolak_h0 <- TRUE
    cat("menolak hipotesis kosong. Rata-rata jarak pada sampel mahasiswa sebesar", round(sample_mean, 2), "km menunjukkan perbedaan yang signifikan")
  }
