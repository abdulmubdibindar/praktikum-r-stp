...
Prinsipnya sama: kita rumuskan hipotesis nol ($H_0$), tentukan hipotesis alternatif ($H_1$), hitung statistik uji (Z atau t), tentukan daerah kritis, lalu disimpulkan.
...
#### Visualisasi Two-Tailed Test ($\alpha$ = 0,05)
...
ggplot(df_normal, aes(x = x, y = y)) +
  ...
  # Tema
  labs(
    title = "Distribusi Normal Standar: Two-Tailed Test (α = 0.05)",
    x = "Nilai Z",
    y = "Densitas"
  ) +
  theme_minimal() +
...
cat(
  "H0 : rata-rata jarak = 4 km", # fungsi "cat()" digunakan untuk mecetak teks ke console dengan format yang bisa kita atur sendiri.
  "\n\nH1 : rata-rata jarak != 4 km"
) # "!=" berarti "tidak sama dengan" (menandakan uji dua sisi).
```
