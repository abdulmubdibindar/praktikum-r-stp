...
```{r mod05-create-function-mean-1pop}
...
```{r mod05-declare-variables-mean-1pop}
...
```{r mod05-hypothesis-mean-1pop-twotail}
...
```{r mod05-critical-value-mean-1pop-twotail}
...
```{r mod05-test-statistic-mean-1pop-twotail}
...
```{r mod05-conclusion-mean-1pop-twotail}
...
```{r mod05-hypothesis-mean-1pop-onetail}
...
```{r mod05-critical-value-mean-1pop-onetail}
...
```{r mod05-test-statistic-mean-1pop-onetail}
...
```{r mod05-conclusion-mean-1pop-onetail}
...
```{r mod05-create-function-prop-1pop}
...
```{r mod05-summarize-housing-data}
...
```{r mod05-declare-variables-prop-1pop}
# Mendeklarasikan variabel-variabel yang akan diuji
...
```{r mod05-hypothesis-prop-1pop-twotail}
...
```{r mod05-critical-value-prop-1pop-twotail}
# Hipotesis yang dipakai tidak berarah, maka wilayah kritis adalah alpha/2
...
```{r mod05-test-statistic-prop-1pop-twotail}
...
```{r mod05-conclusion-prop-1pop-twotail}
...
```{r mod05-hypothesis-prop-1pop-onetail}
cat("H0 : prop. Kos/Asrama = 0,5",
    "\n\nH1 : prop. Kos/Asrama < 0,5")
```
...
```{r mod05-critical-value-prop-1pop-onetail}
tail <- "kiri"
...
```{r mod05-test-statistic-prop-1pop-onetail}
# Hasil perhitungan statistik uji TIDAK diabsolutkan
...
```{r mod05-conclusion-prop-1pop-onetail}
...
```{r mod05-create-function-mean-2pop}
...
```{r mod05-declare-variables-mean-2pop}
...
```{r mod05-hypothesis-mean-2pop-twotail}
...
```{r mod05-critical-value-mean-2pop-twotail}
# Hipotesis yang dipakai tidak berarah, maka wilayah kritis adalah alpha/2
alpha <- 0.001
...
```{r mod05-test-statistic-mean-2pop-twotail}
# Hasil perhitungan statistik uji diabsolutkan
...
```{r mod05-conclusion-mean-2pop-twotail}
...
```{r mod05-hypothesis-mean-2pop-onetail}
cat("H0: mu_jarakUINRIL - mu_jarakITERA = 0",
    "\n\nH1: mu_jarakUINRIL - mu_jarakITERA < 0")
```
...
```{r mod05-critical-value-mean-2pop-onetail}
tail <- "kiri"
...
```{r mod05-test-statistic-mean-2pop-onetail}
# Hasil perhitungan statistik uji TIDAK diabsolutkan
...
```{r mod05-conclusion-mean-2pop-onetail}
...
```{r mod05-create-function-prop-2pop}
# Membuat fungsi uji hipotesis (hypothesis testing, ht) untuk rata-rata (mean)
...
```{r mod05-declare-variables-prop-2pop}
...
```{r mod05-test-prop-2pop-twotail}
...
```{r mod05-test-prop-2pop-onetail}
