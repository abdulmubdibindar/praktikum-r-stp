...
```{r mod02-rename-demo1-conventional}
...
```{r mod02-create-factor-gender-wrong}
...
```{r mod02-create-factor-gender-correct}
...
```{r mod02-check-categorical-values}
...
```{r mod02-tbl-summary-categorical}
data.ubl |> 
...
```{r mod02-tbl-summary-numeric-advanced}
data.ubl |> 
  tbl_summary(include = c(kepemilikan.mobil,
                          kepemilikan.motor,
                          jarak),
