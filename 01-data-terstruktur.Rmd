# Pengolahan Data Terstruktur {#modul-1}
...
```{r mod01-export-csv, echo=TRUE, eval=FALSE}
...
```{r mod01-export-xlsx, echo=TRUE, eval=FALSE}
...
```{r mod01-export-csv-dir, echo=TRUE, eval=FALSE}
